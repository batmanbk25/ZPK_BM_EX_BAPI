*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVI_BM_EXBA_PAR
*   generation date: 26.09.2022 at 23:42:20
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVI_BM_EXBA_PAR     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVI_BM_EXBA_PAR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVI_BM_EXBA_PAR_EXTRACT
...
CALL FUNCTION 'VIEWPROC_ZVI_BM_EXBA_PAR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVI_BM_EXBA_PAR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_BM_EXBA_PAR_EXTRACT
TOTAL = ZVI_BM_EXBA_PAR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVI_BM_EXBA_PAR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVI_BM_EXBA_PAR'
...
TOTAL = ZVI_BM_EXBA_PAR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVI_BM_EXBA_PAR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVI_BM_EXBA_PAR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVI_BM_EXBA_PAR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVI_BM_EXBA_PAR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVI_BM_EXBA_PAR_EXTRACT
TOTAL = ZVI_BM_EXBA_PAR_TOTAL
